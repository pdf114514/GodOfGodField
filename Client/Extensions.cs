...
public static class IJSInProcessRuntimeExtension {
    ...
    public static ValueTask<T> GetProperty<T>(this IJSInProcessRuntime jsRuntime, IJSInProcessObjectReference jsObjRef, string identifier) => jsRuntime.InvokeAsync<T>("getProperty", jsObjRef, identifier);
    public static ValueTask SetProperty<T>(this IJSInProcessRuntime jsRuntime, IJSInProcessObjectReference jsObjRef, string identifier, T value) => jsRuntime.InvokeVoidAsync("setProperty", jsObjRef, identifier, value);
}
